...
namespace CREDAJAX.Serves
{
    ...
    public class BackUp
    {
        ...
        private readonly string _fromEmail = "naalkotabahnaal@gmail.com"; // بريد المرسل
        private readonly string _fromPassword = "slyzgivbtiwzfogr"; // كلمة مرور التطبيقات
        private readonly string _smtpServer = "smtp.gmail.com";
        private readonly int _smtpPort = 587;
        private readonly string _toEmail = "gamingnael712@gmail.com"; // البريد الذي سيتم إرسال النسخة إليه

        public BackUp(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("Mycon");
            _backupFolderPath = "C:\\DatabaseBackups"; // مجلد حفظ النسخة الاحتياطية
        }
